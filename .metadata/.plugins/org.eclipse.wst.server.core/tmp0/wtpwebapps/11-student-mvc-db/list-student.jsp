...
<nav class="navbar navbar-light bg-light justify-content-between">
  <form class="form-inline" action="StudentController" method="get">
  	<input name="command" value="search" type="hidden"/>
    <input class="form-control mr-sm-2" type="search" placeholder="Search by First Name" aria-label="Search" name="first_name"/>
			...
			<tbody>
				<c:forEach var="student" items="${theStudentList}">
					<tr>
						...
						<td>
							<a href="StudentController?command=delete&id=${student.id}" class="btn btn-warning">Delete</a>
						</td>
					</tr>
				</c:forEach>
			</tbody>
