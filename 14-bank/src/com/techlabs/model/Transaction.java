...
public class Transaction {
	...
	public Transaction(int sender_account_number2, int receiver_account_number2, String string, double amount) {
		this.sender_account_number=sender_account_number2;
		this.receiver_account_number=receiver_account_number2;
